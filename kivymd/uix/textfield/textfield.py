...
# from Arabic_for_Kivy import ArLabel as Label
...
class MDTextField(ThemableBehavior, TextInput):
        ...
        if self.mode != "round":
            ...
            if self.mode == "rectangle":
                ...
                if self.halign == "left":
                    ...
                    _hint_x = self.width - self._hint_text_label.texture_size[0] + dp(20)
                Animation(
                    _hint_x=_hint_x if not self.icon_left else dp(36),
                    duration=0.2,
                    t="out_quad",
                ).start(self)
    ...
    def set_objects_labels(self) -> None:
        ...
        self._hint_text_label = TextfieldLabel(
            font_style="Subtitle1", font_name="assets/languages/AL-Mohanad.ttf",
            halign=self.halign, valign="middle", field=self
        )
